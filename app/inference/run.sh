...
huggingface_model_local_dir=/data/models/SparkAudio/Spark-TTS-0.5B
trt_dtype=bfloat16
trt_weights_dir=${huggingface_model_local_dir}/tllm_checkpoint_${trt_dtype}
trt_engines_dir=${huggingface_model_local_dir}/trt_engines_${trt_dtype}
